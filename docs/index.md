...
- [ComfyUI Simple Avatar Generation Workflow](./comfyui_avatar_body_depth_transparent.md): active transparent avatar workflow template, required nodes, placeholders, PuLID identity, and depth ControlNet limits.
