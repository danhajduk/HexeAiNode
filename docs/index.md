...
- [ComfyUI Avatar Body Depth Transparent Workflow](./comfyui_avatar_body_depth_transparent.md): active transparent avatar workflow template, required nodes, placeholders, and depth ControlNet limits.
