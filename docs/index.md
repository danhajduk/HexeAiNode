...
- [ComfyUI Avatar Identity Transparent Workflow](./comfyui_avatar_identity_transparent.md): transparent avatar workflow template, required nodes, placeholders, and ReferenceLatent limits.
